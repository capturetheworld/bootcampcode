(function () {
    ...
    if (Array.isArray(collection)) {
      for (var property in collection) {
        if (!isNaN(property)) {
          ...
          // console.log([collection[property], property]);
          iterator(collection[property], parseInt(property), collection);
        }
      }
    } else {
      for (var property in collection) {
  ...
  _.uniq = function (array, isSorted, iterator) {
    ...
    if (iterator) {
      ...
      for (var item in array) {
        ...
        var currLength = temp.size;
        console.log(temp);

        temp.add(iterator(array[item]));
        console.log(temp);
        if (currLength !== temp.size) {
          set.add(array[item]);
        }
      }
    } else {
  ...
  _.map = function (collection, iterator) {
    ...
    for (var item in collection) {
      toReturn.push(iterator(collection[item]));
    }
  ...
  _.reduce = function (collection, iterator, accumulator) {
    ...
    var start = 0;
    if (Array.isArray(collection)) {
      // console.log("an array with length " + collection.length);
    ...
    if (size <= 1) {
      // console.log("here 1");
      toReturn = iterator(accumulator, collection[0]);
    }
    else {
      // console.log("here 2");
      ...
      for (var i = start; i < size; i++) {
        ...
        toReturn = iterator(toReturn, collection[i]);
  ...
  _.some = function (collection, iterator) {
    ...
    if (Array.isArray(collection)) {
      for (var element in collection) {
        ...
        if (!iterator) {
          if (_.every([collection[element]]) === true) {
            return true;
          }
        }
        else if (_.every([collection[element]], iterator) === true) {
          return true;
        }
      }
      return false;
  ...
  _.memoize = function (func) {
    ...
    return function () {
      ...
      console.log(result);
      var key = Array.prototype.slice.call(arguments, 0).join(' ');
  ...
  _.delay = function (func, wait) {
    ...
    // setTimeout(func, wait, Array.prototype.slice.call(arguments, 2));
