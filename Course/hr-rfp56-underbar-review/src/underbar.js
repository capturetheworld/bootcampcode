(function() {
  ...
  _.reduce = function(collection, iterator, accumulator) {
    var needsAcc = accumulator === undefined;
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(acc, item) {
      return acc && Boolean(iterator(item));
    }, true);
  };
  ...
  _.sortBy = function(collection, iterator) {
    ...
    var values = _.map(collection, _.identity);
    values.sort(function(a, b) {
      var sortByA = iterator(a);
      var sortByB = iterator(b);
      if (sortByA > sortByB) {
        return 1;
  ...
  _.intersection = function() {
    var sets = _.map(arguments, function(array) { return new Set(array); });
